...
public class ClienteController {
    ...
    @PostMapping(value = "/clientes", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    ...
    @PutMapping(value = "/clientes/{id}" , consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
